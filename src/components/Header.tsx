...
const Header = () => {
  ...
  try {
    console.log('Header: Getting contexts...');
    ...
    console.log('Header: Contexts obtained successfully');
    ...
    console.log('Header: Rendering JSX...');
    ...
    console.error('Header: Error rendering:', error);
