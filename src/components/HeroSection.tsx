...
const HeroSection = () => {
  ...
  try {
    console.log('HeroSection: Getting language context...');
    const { t } = useLanguage();
    console.log('HeroSection: Language context obtained');

    console.log('HeroSection: Rendering JSX...');
    ...
    console.error('HeroSection: Error rendering:', error);
    return <div>HeroSection Error: {(error as Error).message}</div>;
  }
};
