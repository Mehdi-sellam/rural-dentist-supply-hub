              ...
              <CardContent className="p-0">
                ...
                <div className="premium-gradient p-6 relative">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-center mb-4">
                      <div className="text-3xl font-bold text-primary heading-professional">{bundle.bundlePrice}</div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mb-6 text-sm">
                    <div className="text-center">
                      <div className="font-bold text-primary heading-professional">{bundle.procedures}</div>
