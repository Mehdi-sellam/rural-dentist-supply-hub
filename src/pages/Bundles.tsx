    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {bundles.map((bundle) => (
            <Card key={bundle.id} className="overflow-hidden hover:shadow-xl transition-all duration-300">
              <CardContent className="p-0">
                {/* Bundle Header */}
                <div className="bg-gradient-to-br from-primary/10 to-accent/20 p-6 relative">
                  {bundle.popular && (
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-center mb-4">
                      ...
                      <div className="text-green-600 font-bold">Save {bundle.savings}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="text-xs text-gray-500 space-y-1 mb-6">
                    <p className="rtl"><span className="font-medium">العربية:</span> {bundle.nameAr}</p>
                    <p className="italic"><span className="font-medium">Français:</span> {bundle.nameFr}</p>
                  </div>
        ...
        <section className="mt-16 bg-gray-50 rounded-2xl p-8">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Our Bundles?</h2>
            <p className="text-gray-600">Designed specifically for busy dental practices</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-sm text-gray-600">Save up to 25% compared to individual purchases</p>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <p className="text-sm text-gray-600">All items tested and approved by dental professionals</p>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <h3 className="font-bold mb-2">Complete Solutions</h3>
              <p className="text-sm text-gray-600">Everything you need for specific procedures in one package</p>
            </div>
          </div>
        </section>
      </div>
